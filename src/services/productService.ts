...
const MOCK_PRODUCTS: Product[] = [
  {
    ...
    images: ['https://images.unsplash.com/photo-1591047139829-d91aecb6caea?q=80&w=2670&auto=format&fit=crop'],
    sizes: ['S', 'M', 'L', 'XL'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1516826957135-700dedea698c?q=80&w=2070&auto=format&fit=crop'],
    sizes: ['M', 'L', 'XL'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1475178626620-a4d074967452?q=80&w=2000&auto=format&fit=crop'],
    sizes: ['30', '32', '34', '36'],
    colors: ['Sand', 'Navy'],
    inventoryCount: 0,
    createdAt: new Date().toISOString()
  },
  {
    ...
    category: 'women',
    subCategory: 'Dresses',
    images: ['https://images.unsplash.com/photo-1581333100576-b73bbe92c2cb?q=80&w=2070&auto=format&fit=crop'],
    sizes: ['XS', 'S', 'M', 'L'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1539109132314-34a93a553f19?q=80&w=2040&auto=format&fit=crop'],
    sizes: ['S', 'M'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1548036328-c9fa89d128fa?q=80&w=2070&auto=format&fit=crop'],
    sizes: ['One Size'],
    colors: ['Tan', 'Black'],
    inventoryCount: 5,
    isFeatured: true,
  ...
  {
    id: 'm5',
    name: 'Artisan Heritage Kurta-Panjabi',
    description: 'A masterpiece of traditional craftsmanship. This architectural Kurta-Panjabi features delicate hand-embroidery on premium breathable fabric. Defined by its sophisticated silhouette and cultural depth.',
    price: 12500,
    category: 'men',
    subCategory: 'Heritage',
    images: ['/pant-shirt-combo.jpeg'],
    sizes: ['M', 'L', 'XL'],
  ...
  {
    id: 'm6',
    name: 'Executive Pant-Shirt Combo',
    description: 'The ultimate versatile pairing for the modern professional. Precisely tailored shirt in high-thread-count cotton matched with our signature structural trousers. A seamless blend of comfort and authority.',
    price: 15800,
    category: 'men',
    subCategory: 'Executive',
    images: ['/kurta-panjabi.jpeg'],
    sizes: ['M', 'L', 'XL'],
    colors: ['Midnight Duo'],
    inventoryCount: 10,
    isFeatured: true,
